...
abstract class AppDatabase : RoomDatabase() {
    ...
    private class AppDatabaseCallback(
        ...
        suspend fun populateDatabase(settingDao: SettingDao, productDao: ProductDao) {
            // Seed settings
            settingDao.insertSetting(SettingEntry("nama_toko", "RM. Mekar Sari"))
            ...
            productDao.insertProduct(Product(nama = "Sate Ayam", harga = 20000L, stok = 25, kategori = "Makanan"))
            productDao.insertProduct(Product(nama = "Soto Ayam", harga = 15000L, stok = 35, kategori = "Makanan"))
            productDao.insertProduct(Product(nama = "Bakso Sapi", harga = 16000L, stok = 45, kategori = "Makanan"))
            productDao.insertProduct(Product(nama = "Tempe Mendoan", harga = 10000L, stok = 60, kategori = "Cemilan"))
            productDao.insertProduct(Product(nama = "Pisang Goreng", harga = 8000L, stok = 40, kategori = "Cemilan"))
            productDao.insertProduct(Product(nama = "Es Kelapa Muda", harga = 8000L, stok = 50, kategori = "Minuman"))
            productDao.insertProduct(Product(nama = "Jus Alpukat", harga = 10000L, stok = 30, kategori = "Minuman"))
        }
    }
}
